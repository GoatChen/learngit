      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li class="login"><a href="${pageContext.request.contextPath}/shopLoginRegister/toLogin"><span>注销</span></a></li>
          </ul>
        </div>
        <!-- /.cnt-account -->
        <!-- 菜单左上角，已删除 -->
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown"> <a href="${pageContext.request.contextPath}/shopcar/buyshopcar/${buyUserSession.id}">全部商品</a> </li>
                <li class="dropdown yamm mega-menu"> <a href="#" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">降价商品0</a> </li>
                <li class="dropdown yamm mega-menu"> <a href="#" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">库存紧张0</a> </li>
                	
                </li>
                <li class="dropdown  navbar-right special-menu"> <a href="${pageContext.request.contextPath}/shopIndex/toGoodsDetail?goodsId=1">立即领取200元新用户红包</a> </li>
              </ul>
              <!-- /.navbar-nav -->
              <div class="clearfix"></div>
            </div>
