...
public interface ShopAddressInsertOrUpdateMapper {
	 ...
	 * @return
	 */
	List<ShopAddress> selectAddress(@Param("buy_id") int buy_id,@Param("currentPageNo") int currentPageNo,@Param("pageSize") int pageSize);
