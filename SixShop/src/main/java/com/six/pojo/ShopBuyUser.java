...
public class ShopBuyUser implements Serializable {
	...
	public String toString() {
		return "ShopBuyUser [id=" + id + ", code=" + code + ", password=" + password + ", phone=" + phone + ", email="
				+ email + ", name=" + name + ", sex=" + sex + ", birthday=" + birthday + ", picPojoPath=" + picPojoPath
				+ ", picLocalPath=" + picLocalPath + ", ban=" + ban + ", money=" + money + ", points=" + points
	...
	public ShopBuyUser(Integer id, String code, String password, String phone, String email, String name, String sex,
